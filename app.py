...
st.markdown(
  "I am a *Data scientist* You can connect with me on [LinkedIn](https://www.linkedin.com/in/aryanbhoi0005/) and [Github](https://github.com/AryanBhoi0005)",
)
...
# st.write(info.astype(int).info())
    ...
    if st.button("Jaundice test result"):
        jaundice_prediction=[[]]
        jaundice_prediction = jaundice_model.predict([[age,Sex,Total_Bilirubin,Direct_Bilirubin,Alkaline_Phosphotase,Alamine_Aminotransferase,Total_Protiens,Albumin]]) # type: ignore
